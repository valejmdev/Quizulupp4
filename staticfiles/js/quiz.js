document.addEventListener('DOMContentLoaded', function() {
    ...
    // Ensure buttons and hiddenInput exist before attaching event listeners
    if (buttons.length > 0 && hiddenInput && form) {
    ...
    // Ensure the modal, input, and buttons exist before attaching event listeners
    if (linkModal && quizLinkInput && generateLinkButtons.length > 0) {
