...
class UsersConfig(AppConfig):
    ...
    It is used by Django to initialize the app and
    ...
    def ready(self):
        ...
        The 'users.signals' module is imported to ensure tha
        t the signal handlers are registered and active when the app is ready.
        """
