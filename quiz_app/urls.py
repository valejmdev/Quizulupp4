...
urlpatterns = [
    ...
    path('quiz-creator/', views.MyQuizCreateView.as_view(),
         name='quiz-creator'),
    ...
    path('quiz/<int:pk>/questions/new/', views.QuestionCreateView.as_view(),
         name='question-creator'),
    # Page to edit a specific quiz
    path('quiz/<int:pk>/edit/', views.QuizUpdateView.as_view(),
         name='quiz-update'),
    # Page to delete a specific quiz
    path('quiz/<int:pk>/delete/', views.QuizDeleteView.as_view(),
         name='quiz-delete'),
    ...
    path('quiz/<int:quiz_id>/results/', views.quiz_results,
         name='quiz_results'),
