...
class Question(models.Model):
    """
    Represents a question within a quiz, including the correct and
    incorrect answers.
...
class UserQuizProgress(models.Model):
    """
    Tracks the progress of a user through a quiz, including their score and
    ...
    Attributes:
        ...
        current_question_index (int): The index of the
